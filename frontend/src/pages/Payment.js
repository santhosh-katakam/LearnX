      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
        ...
        <div className="card">
            ...
            {paymentMethod === 'card' ? (
              ...
              <div style={{ textAlign: 'center' }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '2rem', fontWeight: '700', color: '#1a237e', marginBottom: '1rem' }}>
                    ₹{course.price}
                  </div>
                  <div style={{
                    padding: '1rem',
              ...
              // QR Code Payment
              <div style={{ textAlign: 'center' }}>
                <h4 style={{ color: '#1a237e', marginBottom: '1rem' }}>📲 Pay with PhonePe QR Code</h4>
                <div style={{
                  ...
                  <div style={{
                    ...
                    <img
                      src={`https://api.qrserver.com/v1/create-qr-code/?size=180x180&data=upi://pay?pa=9392963190@ybl&pn=LearnX&am=${course.price}&cu=INR&tn=Course Payment - ${course.title}`}
                      alt="Payment QR Code"
          ...
          <div style={{ marginTop: '1rem', padding: '1rem', backgroundColor: '#f8f9fa', borderRadius: '8px', fontSize: '0.85rem', color: '#666' }}>
            🔒 Your payment information is secure and encrypted. Payments go directly to LearnX's PhonePe account.
          </div>
        </div>
      </div>
    </div>
