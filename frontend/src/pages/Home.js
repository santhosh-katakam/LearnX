      ...
      <div style={{ textAlign: 'center', maxWidth: '1000px', margin: '0 auto' }}>
        <div className="fade-in-up">
          ...
          <p style={{
            ...
            Excellence in Education, Innovation in Learning. Join LearnX's comprehensive online learning platform designed for LearnX academic excellence and professional growth.
          </p>
        </div>
        ...
        <div className="card fade-in-up" style={{
          ...
          <p style={{ fontSize: '1.1rem', opacity: '0.9', marginBottom: '2rem' }}>
            Be part of LearnX's legacy of academic excellence and innovation in Warangal
          </p>
